...
def get_columns():
	...
	columns = [
		...
		{'label': _('Party Type'), 'fieldtype': 'Link', 'options': 'DocType', 'width': 100},
		{'label': _('Party'), 'fieldtype': 'Link', 'options': 'DocType', 'width': 150},
		...
		{'label': _('Stock UOM'), 'fieldtype': 'Link', 'options': 'UOM', 'width': 120},		
